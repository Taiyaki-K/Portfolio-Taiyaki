...
namespace Taiyaki
{
    ...
    {
        [Header("弾のプレハブ")]
        [SerializeField] private GameObject spiralChildBullet3DPrefab;
        [SerializeField] private GameObject spiralChildBullet2DPrefab;
        ...
        private async void Start()
        {
            ...
            try
            {
                await UniTask.WaitForSeconds(spawnerLifetime);
                Destroy(gameObject);
            }
